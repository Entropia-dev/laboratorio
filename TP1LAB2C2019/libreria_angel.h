...
//Comprobamos si el año es bisiesto
        ...
        // Este caso engloba: todas las fechas(ya validadas)  SUPERIOR a la actual.


        if ( aux == 1 && reg.anio == time->tm_year+1900  )
        {

            if ( aux == 1 && reg.mes > time->tm_mon+1   )
            {
                aux++;   // Este es el caso en el que :anio sea el mismo q el actual y el mes mayor al actual.
            }
            else if(aux == 1 && reg.mes == time->tm_mon+1 )  // Estas es el caso en el que: El mes es igual y el dia tiene q ser mayor o igual al actual obviamente.
            {
                if( aux == 1 && reg.dia >= time->tm_mday )
                {
                    aux++;   // Estas es el caso en el que: El mes es igual y el dia tiene q ser mayor o igual al actual obviamente.
                }
                else
                {
                    aux=0;
                   ...
                   //  ESTAS 4 LINEAS DE ABAJO ESTAN BIEN,SIRVEN PARA BORRAR EL TEXTO ANTERIOR INGRESADO.
                    ...
                    gotoxy(21,10);
                    cout << "FECHA INVALIDA PARA CONTROL(Dia Incorrecto) - Dia del Control:           ";
                    gotoxy(83,10);
                    cin >> reg.dia;
                    gotoxy(21,11);
                    cout << "Mes del Control:           ";
            ...
            else
            {
                ...
                gotoxy(21,10);
                cout << "FECHA INVALIDA PARA CONTROL(Mes Incorrecto) - Dia del Control:           ";
                gotoxy(83,10);
                cin >> reg.dia;
                gotoxy(21,11);
                cout << "Mes del Control:           ";
        ...
        else if ( aux == 1 && reg.anio > time->tm_year+1900 )
        {
            aux++;   //Este es el caso en el que: el anio es mayor al actual y automaticamente todas las fechas son validas.
        }
        else
        {
            aux=0;
            ...
            gotoxy(21,10);
            cout << "FECHA INVALIDA PARA CONTROL(Anio Incorrecto) - Dia del Control:           ";
            gotoxy(84,10);
            cin >> reg.dia;
            gotoxy(21,11);
            cout << "Mes del Control:           ";
